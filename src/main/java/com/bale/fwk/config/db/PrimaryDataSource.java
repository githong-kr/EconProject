package com.bale.fwk.config.db;
...
@EnableJpaRepositories(
        basePackages = "com.bale.econproject.repo.jpa",
...
public class PrimaryDataSource {
    ...
    public DataSource embeddedPrimaryDataSource() {
        ...
        ds.setJdbcUrl("jdbc:postgresql://localhost:5432/economic?ssl=false&charset=utf8");
        ds.setUsername("econ");
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(@Qualifier("embeddedPrimaryDataSource") DataSource ds) {
        ...
        em.setPackagesToScan("com.bale.econproject.entity");
